...
public class ReflectionUtil {
     ...
     * with {@link ReflectionUtil#}. This method will substring
     ...
     *
     * @throws ClassNotFoundException
     *           if the class represented by this {@code Type} object cannot be
     *           located.
     * @throws InstantiationException
     *           if this {@code Type} represents an abstract class, an interface,
    ...
    public static boolean hasDefaultConstructor(Class<?> clazz) throws SecurityException {
        ...
        try {
            ...
            logger.error("Constructor cannot be fetched: {}", e.getMessage());
            return false;
        }
        return true;
    }
     ...
     *
     * @param clazz
     *          the {@code Class} object whose declared fields to be checked for a
     *          certain field.
     * @param name
     ...
     *
     * @param clazz
     *          the {@code Class} object whose declared methods to be checked for
